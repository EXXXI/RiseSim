...
CSVの対応状況：サンブレイク Var15.0系統に対応中

本体の最終更新：2023/04/05 シミュ画面やマイセット画面のコピペ用装備詳細に錬成情報を追加

CSVの最終更新：2023/04/20 Var15.0対応中(防具2種・新規スキル3種・装飾品10種追加、冰気と変換を仮でc15にして錬成対象に追加)
