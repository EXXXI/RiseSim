...
64bitマシンで以前のバージョンを利用していた方は、また起動時に.NETのランタイムをインストールするよう案内される可能性があります。

その場合は案内に従い、x64のデスクトップランタイムをインストールしてください。

## 更新・対応状況

本体の対応状況：サンブレイク Var10.0系統に対応

CSVの対応状況：サンブレイク Var10.0系統に対応

本体の最終更新：2022/07/31 64bit対応+64bit時のみメモリリーク対応

CSVの最終更新：2022/07/26 CSV更新(防具強化値追加)
