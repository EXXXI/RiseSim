...
泣きシミュ様の傀異錬成データを読み込めるようになりました。

それに伴い、以前(20200822.0)までの傀異錬成データを引き継いだ場合、起動時に自動でフォーマットが変わるようになっています。

要するに以前(20200822.0)までの傀異錬成データを引き継ぐだけなら何も気にしないでOKです。

泣きシミュ様の傀異錬成データを読み込む場合は、一度RiseSimを起動・終了して、フォーマットが変更になってから、save/augmentation.csvに追記してください。
