...
## お知らせ(20220810.alpha, 20220810.beta)
...
CSVの対応状況：サンブレイク Var11.0系統に対応中(追加防具4シリーズとそのスキルに対応。装飾品は開発者が出せた分だけ追加)

本体の最終更新：2022/08/10 マイナスのスキル値を-2まで入れられるように修正

CSVの最終更新：2022/08/10 追加防具4シリーズとそのスキルに対応。装飾品は開発者が出せた分だけ追加
