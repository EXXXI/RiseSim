...
CSVの対応状況：サンブレイク Var14.0系統に対応中(錬成に追加されたスキルのコスト情報が未対応)

本体の最終更新：2022/02/07 理想錬成を使わない検索結果が錬成不可能と判断されていた不具合を修正

CSVの最終更新：2022/02/07 Var14.0追加装備を追加・ファルメルSマーノの性能を修正
